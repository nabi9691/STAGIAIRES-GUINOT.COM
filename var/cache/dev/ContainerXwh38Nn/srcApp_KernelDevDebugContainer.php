...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder03569 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer29184 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5e1bf = [
        
    ];

    public function getConnection()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getConnection', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getMetadataFactory', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getExpressionBuilder', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'beginTransaction', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getCache', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getCache();
    }

    public function transactional($func)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'transactional', array('func' => $func), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'wrapInTransaction', array('func' => $func), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'commit', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->commit();
    }

    public function rollback()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'rollback', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getClassMetadata', array('className' => $className), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'createQuery', array('dql' => $dql), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'createNamedQuery', array('name' => $name), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'createQueryBuilder', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'flush', array('entity' => $entity), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'clear', array('entityName' => $entityName), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->clear($entityName);
    }

    public function close()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'close', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->close();
    }

    public function persist($entity)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'persist', array('entity' => $entity), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'remove', array('entity' => $entity), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'refresh', array('entity' => $entity), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'detach', array('entity' => $entity), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'merge', array('entity' => $entity), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getRepository', array('entityName' => $entityName), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'contains', array('entity' => $entity), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getEventManager', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getConfiguration', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'isOpen', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getUnitOfWork', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getProxyFactory', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'initializeObject', array('obj' => $obj), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'getFilters', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'isFiltersStateClean', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'hasFilters', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return $this->valueHolder03569->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer29184 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder03569) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder03569 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder03569->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, '__get', ['name' => $name], $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        if (isset(self::$publicProperties5e1bf[$name])) {
            return $this->valueHolder03569->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder03569;
    ...
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;
    ...
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, '__isset', array('name' => $name), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;
    ...
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, '__unset', array('name' => $name), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;
    ...
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, '__clone', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        $this->valueHolder03569 = clone $this->valueHolder03569;
    }

    public function __sleep()
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, '__sleep', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        return array('valueHolder03569');
    }
    ...
    {
        $this->initializer29184 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer29184;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'initializeProxy', array(), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder03569;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder03569;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer29184 && ($this->initializer29184->__invoke($valueHolder03569, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer29184) || 1) && $this->valueHolder03569 = $valueHolder03569;

        if ($this->valueHolder03569 === $returnValue = $this->valueHolder03569->paginate($target, $page, $limit, $options)) {
            return $this;
        }
