...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldercb914 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer994d5 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties2cce4 = [
        
    ];

    public function getConnection()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getConnection', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getMetadataFactory', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getExpressionBuilder', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'beginTransaction', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getCache', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getCache();
    }

    public function transactional($func)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'transactional', array('func' => $func), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'wrapInTransaction', array('func' => $func), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'commit', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->commit();
    }

    public function rollback()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'rollback', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getClassMetadata', array('className' => $className), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'createQuery', array('dql' => $dql), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'createNamedQuery', array('name' => $name), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'createQueryBuilder', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'flush', array('entity' => $entity), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'clear', array('entityName' => $entityName), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->clear($entityName);
    }

    public function close()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'close', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->close();
    }

    public function persist($entity)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'persist', array('entity' => $entity), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'remove', array('entity' => $entity), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'refresh', array('entity' => $entity), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'detach', array('entity' => $entity), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'merge', array('entity' => $entity), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getRepository', array('entityName' => $entityName), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'contains', array('entity' => $entity), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getEventManager', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getConfiguration', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'isOpen', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getUnitOfWork', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getProxyFactory', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'initializeObject', array('obj' => $obj), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'getFilters', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'isFiltersStateClean', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'hasFilters', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return $this->valueHoldercb914->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer994d5 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldercb914) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldercb914 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldercb914->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, '__get', ['name' => $name], $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        if (isset(self::$publicProperties2cce4[$name])) {
            return $this->valueHoldercb914->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldercb914;
    ...
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;
    ...
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, '__isset', array('name' => $name), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;
    ...
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, '__unset', array('name' => $name), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;
    ...
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, '__clone', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        $this->valueHoldercb914 = clone $this->valueHoldercb914;
    }

    public function __sleep()
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, '__sleep', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        return array('valueHoldercb914');
    }
    ...
    {
        $this->initializer994d5 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer994d5;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'initializeProxy', array(), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldercb914;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldercb914;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer994d5 && ($this->initializer994d5->__invoke($valueHoldercb914, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer994d5) || 1) && $this->valueHoldercb914 = $valueHoldercb914;

        if ($this->valueHoldercb914 === $returnValue = $this->valueHoldercb914->paginate($target, $page, $limit, $options)) {
            return $this;
        }
