...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rmdpkliWKX', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('g-uVl9e+7Q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    /**
     * Gets the private '.service_locator.JJTzy3n' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_JJTzy3nService()
    {
        return $this->privates['.service_locator.JJTzy3n'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UmasS8bsCL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qg5QOQ8oKf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2oIe0qFGLc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TwDOVhBA9h', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zJ8C3N1Kt5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.JJTzy3n'] ?? $this->get_ServiceLocator_JJTzy3nService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder363ba = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerd1b13 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesf4ce4 = [
        
    ];

    public function getConnection()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getConnection', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getMetadataFactory', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getExpressionBuilder', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'beginTransaction', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getCache', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getCache();
    }

    public function transactional($func)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'transactional', array('func' => $func), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'wrapInTransaction', array('func' => $func), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'commit', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->commit();
    }

    public function rollback()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'rollback', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getClassMetadata', array('className' => $className), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'createQuery', array('dql' => $dql), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'createNamedQuery', array('name' => $name), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'createQueryBuilder', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'flush', array('entity' => $entity), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'clear', array('entityName' => $entityName), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->clear($entityName);
    }

    public function close()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'close', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->close();
    }

    public function persist($entity)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'persist', array('entity' => $entity), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'remove', array('entity' => $entity), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'refresh', array('entity' => $entity), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'detach', array('entity' => $entity), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'merge', array('entity' => $entity), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getRepository', array('entityName' => $entityName), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'contains', array('entity' => $entity), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getEventManager', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getConfiguration', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'isOpen', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getUnitOfWork', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getProxyFactory', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'initializeObject', array('obj' => $obj), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'getFilters', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'isFiltersStateClean', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'hasFilters', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return $this->valueHolder363ba->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerd1b13 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder363ba) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder363ba = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder363ba->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, '__get', ['name' => $name], $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        if (isset(self::$publicPropertiesf4ce4[$name])) {
            return $this->valueHolder363ba->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder363ba;
    ...
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;
    ...
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, '__isset', array('name' => $name), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;
    ...
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, '__unset', array('name' => $name), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;
    ...
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, '__clone', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        $this->valueHolder363ba = clone $this->valueHolder363ba;
    }

    public function __sleep()
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, '__sleep', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        return array('valueHolder363ba');
    }
    ...
    {
        $this->initializerd1b13 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerd1b13;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'initializeProxy', array(), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder363ba;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder363ba;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerd1b13 && ($this->initializerd1b13->__invoke($valueHolder363ba, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerd1b13) || 1) && $this->valueHolder363ba = $valueHolder363ba;

        if ($this->valueHolder363ba === $returnValue = $this->valueHolder363ba->paginate($target, $page, $limit, $options)) {
            return $this;
        }
