...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd3397 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer96060 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties6a5b9 = [
        
    ];

    public function getConnection()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getConnection', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getMetadataFactory', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getExpressionBuilder', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'beginTransaction', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getCache', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getCache();
    }

    public function transactional($func)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'transactional', array('func' => $func), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'wrapInTransaction', array('func' => $func), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'commit', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->commit();
    }

    public function rollback()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'rollback', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getClassMetadata', array('className' => $className), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'createQuery', array('dql' => $dql), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'createNamedQuery', array('name' => $name), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'createQueryBuilder', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'flush', array('entity' => $entity), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'clear', array('entityName' => $entityName), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->clear($entityName);
    }

    public function close()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'close', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->close();
    }

    public function persist($entity)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'persist', array('entity' => $entity), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'remove', array('entity' => $entity), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'refresh', array('entity' => $entity), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'detach', array('entity' => $entity), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'merge', array('entity' => $entity), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getRepository', array('entityName' => $entityName), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'contains', array('entity' => $entity), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getEventManager', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getConfiguration', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'isOpen', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getUnitOfWork', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getProxyFactory', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'initializeObject', array('obj' => $obj), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'getFilters', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'isFiltersStateClean', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'hasFilters', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return $this->valueHolderd3397->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer96060 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderd3397) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd3397 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd3397->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, '__get', ['name' => $name], $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        if (isset(self::$publicProperties6a5b9[$name])) {
            return $this->valueHolderd3397->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd3397;
    ...
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;
    ...
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, '__isset', array('name' => $name), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;
    ...
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, '__unset', array('name' => $name), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;
    ...
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, '__clone', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        $this->valueHolderd3397 = clone $this->valueHolderd3397;
    }

    public function __sleep()
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, '__sleep', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        return array('valueHolderd3397');
    }
    ...
    {
        $this->initializer96060 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer96060;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'initializeProxy', array(), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd3397;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd3397;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer96060 && ($this->initializer96060->__invoke($valueHolderd3397, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer96060) || 1) && $this->valueHolderd3397 = $valueHolderd3397;

        if ($this->valueHolderd3397 === $returnValue = $this->valueHolderd3397->paginate($target, $page, $limit, $options)) {
            return $this;
        }
