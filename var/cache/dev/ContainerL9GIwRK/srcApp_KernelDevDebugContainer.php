...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldere7791 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializera1bd8 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiese7010 = [
        
    ];

    public function getConnection()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getConnection', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getMetadataFactory', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getExpressionBuilder', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'beginTransaction', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->beginTransaction();
    }

    public function getCache()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getCache', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getCache();
    }

    public function transactional($func)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'transactional', array('func' => $func), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'wrapInTransaction', array('func' => $func), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'commit', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->commit();
    }

    public function rollback()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'rollback', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getClassMetadata', array('className' => $className), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'createQuery', array('dql' => $dql), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'createNamedQuery', array('name' => $name), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'createQueryBuilder', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'flush', array('entity' => $entity), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'clear', array('entityName' => $entityName), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->clear($entityName);
    }

    public function close()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'close', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->close();
    }

    public function persist($entity)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'persist', array('entity' => $entity), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'remove', array('entity' => $entity), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'refresh', array('entity' => $entity), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'detach', array('entity' => $entity), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'merge', array('entity' => $entity), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getRepository', array('entityName' => $entityName), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'contains', array('entity' => $entity), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getEventManager', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getConfiguration', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'isOpen', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getUnitOfWork', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getProxyFactory', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'initializeObject', array('obj' => $obj), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'getFilters', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'isFiltersStateClean', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'hasFilters', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return $this->valueHoldere7791->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializera1bd8 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldere7791) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldere7791 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldere7791->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, '__get', ['name' => $name], $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        if (isset(self::$publicPropertiese7010[$name])) {
            return $this->valueHoldere7791->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldere7791;
    ...
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, '__set', array('name' => $name, 'value' => $value), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;
    ...
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, '__isset', array('name' => $name), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;
    ...
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, '__unset', array('name' => $name), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;
    ...
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, '__clone', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        $this->valueHoldere7791 = clone $this->valueHoldere7791;
    }

    public function __sleep()
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, '__sleep', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        return array('valueHoldere7791');
    }
    ...
    {
        $this->initializera1bd8 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializera1bd8;
    }

    public function initializeProxy() : bool
    {
        return $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'initializeProxy', array(), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldere7791;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldere7791;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializera1bd8 && ($this->initializera1bd8->__invoke($valueHoldere7791, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializera1bd8) || 1) && $this->valueHoldere7791 = $valueHoldere7791;

        if ($this->valueHoldere7791 === $returnValue = $this->valueHoldere7791->paginate($target, $page, $limit, $options)) {
            return $this;
        }
