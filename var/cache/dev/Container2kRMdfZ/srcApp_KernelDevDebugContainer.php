...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.tDwvBdL' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_TDwvBdLService()
    {
        return $this->privates['.service_locator.tDwvBdL'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.tDwvBdL'] ?? $this->get_ServiceLocator_TDwvBdLService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderf5cde = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer6a01f = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties984c5 = [
        
    ];

    public function getConnection()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getConnection', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getMetadataFactory', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getExpressionBuilder', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'beginTransaction', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getCache', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getCache();
    }

    public function transactional($func)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'transactional', array('func' => $func), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'wrapInTransaction', array('func' => $func), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'commit', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->commit();
    }

    public function rollback()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'rollback', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getClassMetadata', array('className' => $className), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'createQuery', array('dql' => $dql), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'createNamedQuery', array('name' => $name), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'createQueryBuilder', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'flush', array('entity' => $entity), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'clear', array('entityName' => $entityName), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->clear($entityName);
    }

    public function close()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'close', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->close();
    }

    public function persist($entity)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'persist', array('entity' => $entity), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'remove', array('entity' => $entity), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'refresh', array('entity' => $entity), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'detach', array('entity' => $entity), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'merge', array('entity' => $entity), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getRepository', array('entityName' => $entityName), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'contains', array('entity' => $entity), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getEventManager', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getConfiguration', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'isOpen', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getUnitOfWork', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getProxyFactory', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'initializeObject', array('obj' => $obj), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'getFilters', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'isFiltersStateClean', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'hasFilters', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return $this->valueHolderf5cde->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer6a01f = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderf5cde) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderf5cde = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderf5cde->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, '__get', ['name' => $name], $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        if (isset(self::$publicProperties984c5[$name])) {
            return $this->valueHolderf5cde->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderf5cde;
    ...
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;
    ...
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, '__isset', array('name' => $name), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;
    ...
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, '__unset', array('name' => $name), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;
    ...
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, '__clone', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        $this->valueHolderf5cde = clone $this->valueHolderf5cde;
    }

    public function __sleep()
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, '__sleep', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        return array('valueHolderf5cde');
    }
    ...
    {
        $this->initializer6a01f = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer6a01f;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'initializeProxy', array(), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderf5cde;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderf5cde;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer6a01f && ($this->initializer6a01f->__invoke($valueHolderf5cde, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer6a01f) || 1) && $this->valueHolderf5cde = $valueHolderf5cde;

        if ($this->valueHolderf5cde === $returnValue = $this->valueHolderf5cde->paginate($target, $page, $limit, $options)) {
            return $this;
        }
