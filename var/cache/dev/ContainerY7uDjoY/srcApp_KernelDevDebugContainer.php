...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHoldercac58 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerb12f6 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties565b3 = [
        
    ];

    public function getConnection()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getConnection', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getMetadataFactory', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getExpressionBuilder', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'beginTransaction', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getCache', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getCache();
    }

    public function transactional($func)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'transactional', array('func' => $func), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'wrapInTransaction', array('func' => $func), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'commit', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->commit();
    }

    public function rollback()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'rollback', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getClassMetadata', array('className' => $className), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'createQuery', array('dql' => $dql), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'createNamedQuery', array('name' => $name), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'createQueryBuilder', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'flush', array('entity' => $entity), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'clear', array('entityName' => $entityName), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->clear($entityName);
    }

    public function close()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'close', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->close();
    }

    public function persist($entity)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'persist', array('entity' => $entity), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'remove', array('entity' => $entity), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'refresh', array('entity' => $entity), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'detach', array('entity' => $entity), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'merge', array('entity' => $entity), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getRepository', array('entityName' => $entityName), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'contains', array('entity' => $entity), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getEventManager', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getConfiguration', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'isOpen', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getUnitOfWork', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getProxyFactory', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'initializeObject', array('obj' => $obj), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'getFilters', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'isFiltersStateClean', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'hasFilters', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return $this->valueHoldercac58->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerb12f6 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHoldercac58) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHoldercac58 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHoldercac58->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, '__get', ['name' => $name], $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        if (isset(self::$publicProperties565b3[$name])) {
            return $this->valueHoldercac58->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHoldercac58;
    ...
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;
    ...
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, '__isset', array('name' => $name), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;
    ...
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, '__unset', array('name' => $name), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;
    ...
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, '__clone', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        $this->valueHoldercac58 = clone $this->valueHoldercac58;
    }

    public function __sleep()
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, '__sleep', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        return array('valueHoldercac58');
    }
    ...
    {
        $this->initializerb12f6 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerb12f6;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'initializeProxy', array(), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHoldercac58;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHoldercac58;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerb12f6 && ($this->initializerb12f6->__invoke($valueHoldercac58, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerb12f6) || 1) && $this->valueHoldercac58 = $valueHoldercac58;

        if ($this->valueHoldercac58 === $returnValue = $this->valueHoldercac58->paginate($target, $page, $limit, $options)) {
            return $this;
        }
