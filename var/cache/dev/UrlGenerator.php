...
return [
    ...
    'formationPYTHON_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::formationPYTHON_index'], [], [['text', '/formationsformationPYTHON_index']], [], []],
    'formationHTML_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::formationHTML'], [], [['text', '/formationsformationHTML']], [], []],
    'formationCSS_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::formationCSS'], [], [['text', '/formationsformationCSS']], [], []],
    'formationJAVASCRIPT_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::formationJAVASCRIPT'], [], [['text', '/formationsformationJAVASCRIPT']], [], []],
    'formationDotNet_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::formationDotNet'], [], [['text', '/formationsformationDotNet']], [], []],
    'formationC++_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::formationCPlus'], [], [['text', '/formationsformationC++']], [], []],
    'coursEnPresentiel_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::coursEnPresentiel'], [], [['text', '/formationscoursEnPresentiel']], [], []],
    'coursEnVideo_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::coursEnVideo'], [], [['text', '/formationscoursEnVideo']], [], []],
    'coursEnPDF_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::coursEnPDF'], [], [['text', '/formationscoursEnPDF']], [], []],
    'coursEnWord_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::coursEnWord'], [], [['text', '/formationscoursEnWord']], [], []],
    'coursEnLignes_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::coursEnLignes'], [], [['text', '/formationscoursEnLignes']], [], []],
    'coursEnFichierZipp_index' => [[], ['_controller' => 'App\\Controller\\FormationsController::coursEnFichierZipp'], [], [['text', '/formationscoursEnFichierZipp']], [], []],
